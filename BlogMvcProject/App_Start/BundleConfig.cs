    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/scripts").Include(
                        ...
                        "~/Content/js/jquery.filterizr.min.js",
                        "~/Content/js/jquery.popup.min.js",
                        "~/Content/js/owl.carousel.min.js",
                        "~/Content/js/js.js",
                        "~/Content/js/modernizr.js",
                        "~/Content/js/jquery.gmap.min.js",
                        "~/Content/js/viewport-units-buggyfill.hacks.js",
                        "~/Content/js/viewport-units-buggyfill.js",
            ...
            RegisterDatetimePicker(bundles);
        ...
        private static void RegisterDatetimePicker(BundleCollection bundles)
        {
